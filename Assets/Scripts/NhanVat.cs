...
public class NhanVat : MonoBehaviour
{
    ...
    public Slider mau_Slider;
    private int mauMax = 100;
    ...
    public AudioSource audioSource; // Kéo và thả Audio Source vào đây trong trình chỉnh sửa Unity
    ...
    void Update()
    {
        ...
        fillcoler.color = Gradient.Evaluate(mau_Slider.normalizedValue);// cập nhật hiển thị máu theo màu
        ...
        // nếu máu nhỏ hơn 0 thì sẽ hiển thị panel
        if (mauHienTai<=0 && !hasPlayedDeathSound)
        {
            die.SetActive(true);
            Die();
        }
    ...
    private void Die()
    {
        ...
        // Các dòng khác như trong đoạn mã của bạn
    }
